  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-8 bg-gradient-to-b from-background to-muted">
      <div className="text-center space-y-6 max-w-2xl">
        ...
        <h2 className="text-3xl font-semibold">Super Admin Dashboard Error</h2>
        <p className="text-lg text-muted-foreground">
          An error occurred in the super admin dashboard. Please try again or check system logs.
        </p>
